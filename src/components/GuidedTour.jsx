...
const TOURS = {
  ...
  "/pages/:id": [
    ...
    },
    {
      ...
      body: "La previsualización de la derecha muestra tu tienda en tiempo real. Cambiá cualquier opción y lo ves reflejado al instante, sin necesidad de guardar.",
      position: "left",
    },
    {
      selector: "[data-tour='page-save']",
      title: "Guardar los cambios",
      body: "Cuando estés conforme con los cambios, hacé clic en «Guardar». Los cambios se aplican a tu tienda pública de inmediato.",
      position: "top",
    },
  ],
