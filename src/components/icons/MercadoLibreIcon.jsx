// Ícono de línea de Mercado Libre, con la misma API que los íconos de lucide-react
// (acepta size, hereda color vía currentColor) para que funcione igual en el nav.
export default function MercadoLibreIcon({ size = 15, ...props }) {
  return (
